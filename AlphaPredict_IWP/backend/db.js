...
const url=`mongodb+srv://${process.env.ATLAS_DATABASE_USERNAME}:${process.env.ATLAS_DATABASE_PASSWORD}@cluster0.gopnsyv.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`
